...
def generate(repo, output, baseline=BASELINE):
...
'''
    ...
    receipt = {
        ...
        "candidate_production_diff": git(repo, "diff", "--name-only", "HEAD", "--",
        ...
        "production_bodies_modified": False,
...
if __name__ == "__main__":
    ...
    print(json.dumps(generate(arguments.repo, arguments.output, arguments.baseline), indent=2))
